...
class Gallery extends Component {
  state = {activeImage: imagesList[0], initialImagesList: imagesList}

  onClickImage = id => {
    this.setState({activeImage: imagesList[id]})
  }

  render() {
    const {activeImage, initialImagesList} = this.state
    return (
        ...
        <div className="thumbnail-container">
          <div className="gallery-container">
            ...
            <ul className="thumbnail-container">
              {initialImagesList.map(eachImage => (
                <ThumbnailItem
